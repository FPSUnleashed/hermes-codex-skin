...
test('dark queued-message editing has no blue border and a light Save pill', () => {
  assert.match(source, /\[data-hermes-mode='dark'\] \[data-codex-edit-banner='true'\] \{[\s\S]{0,200}border-color: rgba\(255, 255, 255, 0\.10\) !important/)
  assert.match(source, /\[data-hermes-mode='dark'\] \[data-codex-edit-banner='true'\] button:last-child \{[\s\S]{0,180}background: #ececec !important/)
...
test('the native inline message editor reuses the Codex user bubble', () => {
  ...
  assert.match(source, /\[data-slot='aui_edit-composer-root'\] \[data-slot='composer-rich-input'\] \{[\s\S]{0,240}font-size: 14px !important/)
